...
# You can specify multiple suffix as a _list of string:
#
...
# for a _list of supported languages.
#
...
# a _list of builtin themes.
#
html_theme = 'sphinx_rtd_theme'

# Theme options are theme-specific and customize the look and feel of a theme
# further.  For a _list of options available for each theme, see the
# documentation.
...
# A _list of files that should not be packed into the epub file.
